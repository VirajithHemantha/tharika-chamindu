...
const events = [
  { time: '10:00 AM', title: 'Poruwa Ceremony', icon: Heart, desc: 'The sacred traditional ceremony' },
  { time: '12:00 PM', title: 'Wedding Lunch', icon: Utensils, desc: 'A grand celebratory lunch' },
  { time: '03:30 PM', title: 'Farewell', icon: PartyPopper, desc: 'Thank you for joining our special day' },
];
